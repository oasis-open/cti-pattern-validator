...
SPEC_CASES = [
    ...
    """[user-account:account_type = 'unix' AND user-account:user_id = '1007' AND user-account:account_login = 'Peter'] AND [user-account:account_type = 'unix' AND user-account:user_id = '1008' AND user-account:user_id = 'Paul'] AND [user-account:account_type = 'unix' AND user-account:user_id = '1009' AND user-account:user_id = 'Mary']""",
    ...
    """[process:arguments = '>-add GlobalSign.cer -c -s -r localMachine Root'] FOLLOWEDBY [process:arguments = '>-add GlobalSign.cer -c -s -r localMachineTrustedPublisher'] WITHIN 300 SECONDS""",
