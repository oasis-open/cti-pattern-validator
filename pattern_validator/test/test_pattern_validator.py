...
SPEC_CASES = [
    ...
    # REPEATED not yet supported in the Grammar
...
PASS_CASES = [
    ...
    "[NOT ipv4addr:value INSUBNET '192.168.0.1/24']",
    "[user-account:value = 'Peter'] ALONGWITH [NOT user-account:value = 'Paul'] ALONGWITH [user-account:value = 'Mary'] WITHIN 5 MINUTES",
